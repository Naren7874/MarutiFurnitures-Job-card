...
const ALL_PERMISSIONS: Record<string, string[]> = {
    ...
    project:         ['project.create', 'project.view', 'project.edit', 'project.delete'],
    jobcard:         ['jobcard.create', 'jobcard.view', 'jobcard.edit', 'jobcard.delete', 'jobcard.export', 'jobcard.close', 'jobcard.assign', 'jobcard.override_status'],
    designrequest:   ['designrequest.create', 'designrequest.view', 'designrequest.edit', 'designrequest.upload', 'designrequest.signoff'],
    ...
    invoice:         ['invoice.create', 'invoice.view', 'invoice.edit', 'invoice.delete', 'invoice.send', 'invoice.payment', 'invoice.archive'],
    inventory:       ['inventory.create', 'inventory.view', 'inventory.edit', 'inventory.delete'],
    ...
    privilege:       ['privilege.view', 'privilege.create', 'privilege.edit', 'privilege.delete', 'privilege.grant', 'privilege.deny'],
