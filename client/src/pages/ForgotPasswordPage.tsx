    ...
    if (isSent) {
        return (
            <div className="min-h-screen flex items-center justify-center relative overflow-hidden selection:bg-primary/30 font-sans transition-colors duration-500">
                ...
                >
                    <Card className="glass dark:glass-dark border border-neutral-200 dark:border-white/10 rounded-[40px] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.1)] dark:shadow-[0_40px_100px_-20px_rgba(0,0,0,0.8)] backdrop-blur-3xl p-12 relative overflow-hidden transition-all duration-500">
                        <div className="w-20 h-20 bg-primary/10 rounded-3xl flex items-center justify-center mx-auto text-primary mb-8 shadow-inner border border-primary/20">
                                    ...
                                    >
                                        <span className="relative z-10 flex items-center justify-center gap-3">
                                            {isSubmitting ? (
                                                ...
                                                <>Send Reset Link <ArrowRight size={24} className="group-hover:translate-x-2 transition-transform duration-500" /></>
                                            )}
                                        </span>
